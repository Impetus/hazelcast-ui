...
public class CacheInstance {
	...
	private static final Map<String, JMXConnector> JMX_CONNECTION_CACHE =
	...
	private void initializeInstance() {
		...
		final String[] addrSplits = etlCluster.split(COMMA_SEPARATOR);
	...
	/**
	 * @Description This method is used to return JMXConnector
	 * @return JMXConnector
	 * @param ipAddress .
	 */
	...
	/**
	 * @Description This method is used to set the Ip of node for JMX connections
	 * @param ipAddress .
	 * @param connection .
	 */
	public void setConnectionForHost(final String ipAddress,
